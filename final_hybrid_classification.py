...
# Automatically switched to the newly trained Custom CNN 640x640 version
MODEL_TYPE = 'custom_cnn'  
WEIGHTS_PATH = 'custom_cnn_checkpoint/best_custom_cnn_model.pth' 
...
def get_target_layers(model, model_type):
    ...
    if 'resnet' in model_type:
        ...
        try:
            # Adapt to the last layer of the CustomCNN26 architecture
...
def main():
    ...
    while cap.isOpened():
        ...
        # 4. Dynamically calculate the center position of the original image and paste back the 640x640 heatmap 🧩
